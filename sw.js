/*
 * The Toji Method · service worker
 * Built by Alexander Ortega (theotheralex) — © 2025
 * github.com/theotheralex · ko-fi.com/theotheralex
 *
 * Strategy: network-first with cache fallback. Bump C to invalidate caches.
 */
const C='toji-v22';
